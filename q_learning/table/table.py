...
class Table(dict):
    ...
    def add_row(self, row_label: Hashable, row: list[tuple[Hashable,Any]]) -> None:
        """Add a new row entry.
        ...
        try:
            ...
            super().__setitem__(row_label, {column_label: value for column_label, value in row})
    ...
    def element_at(self, row_label: Hashable, column_label: Hashable) -> Any:
        ...
        try:
            ...
            raise ColumnError(f"Column {column_label} does not have a value in the row {row_label}.")
